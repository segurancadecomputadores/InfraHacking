...
![qownnotes-media-weBIjG](file://Images/Chapters/0x05a/android_software_stack.png) 
...
![qownnotes-media-weBIjG](file://Images/Chapters/0x05a/java_vs_dalvik.png)
...
![qownnotes-media-weBIjG](file://Images/Chapters/0x05a/Selection_003.png)
...
*Binder Overview - Image source: [Android Binder by Thorsten Schreiber](../../attachments/files/2011/10/main.pdf "Android Binder")*
...
- *Dangerous*: This permission allows the app to perform actions that might affect the userâ€™s privacy or the normal operation of the userâ€™s device. This level of permission may not be granted during installation; the user must decide whether the app should have this permission.
...
Android components can be protected with permissions. Activities, Services, content providers, and Broadcast Receiversâ€”all can use the permission mechanism to protect their interfaces.
...
- Validate all input by means of IPC communication or URL schemes, see also:
  - [Testing for Sensitive Functionality Exposure Through IPC][4]
...
- Securely communicate with backend servers or is susceptible to man-in-the-middle attacks between the server and the mobile application, see also:
  - [Testing Network Communication][3]
  - [Android Network APIs][2]
- Securely stores all local data, or loads untrusted data from storage, see also:
  - [Data Storage on Android][1] "Data Storage on Android"
- Protect itself against compromised environments, repackaging or other local attacks, see also:
 - [Android Anti-Reversing Defenses][5]


[1]: note://0x05d\-Testing\-Data\-Storage
[2]: note://0x05g\-Testing\-Network\-Communication
[3]: note://0x04f\-Testing\-Network\-Communication
[4]: note://0x05h\-Testing\-Platform\-Interaction
[5]: note://0x05j\-Testing\-Resiliency\-Against\-Reverse\-Engineering